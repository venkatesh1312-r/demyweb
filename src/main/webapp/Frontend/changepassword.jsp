...
<link rel="stylesheet"
	href="<c:url value='https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.min.css'/>">
<link rel="stylesheet"
...
<link href="<c:url value='lib/bootstrap/css/bootstrap.min.css'/>"
	rel="stylesheet">
<link href="<c:url value='lib/ionicons/css/ionicons.min.css'/>"
	rel="stylesheet">
<link
...
<body>
	<header class="header">
		<a href="#" class="logo"><img
			src="<c:url value='./images/logo.png'/>" alt="demy logo"></a>
		...
		<nav class="navbar">
			<ul>
				...
				<li><a href="./employeeLogin" class="btn btn-danger">Employee
						Login</a></li>
	...
	<div class="contact-in">
		<div class="contact-map">
			<img src="./images/pexels-andrea-piacquadio-845434.jpg"
				class="img-fluid" alt="Team member 1">
		</div>
		<div class="contact-form d-flex justify-content-center"
			style="margin-top: 10%">
			<form action="/changePassword" method="POST">

				<span style="color: red; text-align: center; margin: 90px 30px;">${msg}</span><br>
				<br>
				<br> <input type="text" name="password"
					placeholder="Enter New Password" class="contact-form-email"
					required> <input type="submit" value="Submit"
					name="submit" class="contact-form-btn">
