    ...
    <div class="career">
        <div class="career-form">
            ...
            <span style="text-align: center; margin:90px 30px;" class="${style}">${msg}&nbsp;&nbsp;${email}</span><br><br><br>
                 ...
                 <input type="text" name="name" placeholder="Name" class="career-form-txt" required pattern="[a-zA-Z\s]+" title="Name can only contain alphabets and white spaces">
                
                
                <input type="tel" id="phone" name="phone" pattern="[0-9]{10}" required placeholder="Contact number" maxlength="10" class="career-form-phone" title="10-digits only">
                ...
                <div class="file">
                    ...
                    <input class="upload" type="file" name="file" accept=".doc,.docx,.pdf" required><br><br><br>
                </div>
