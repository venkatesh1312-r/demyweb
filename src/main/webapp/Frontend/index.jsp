...
<div class="contact-in">
    <div class="contact-map">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3800.3586945984093!2d83.29252537494303!3d17.727730283218648!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a3943247abeba5b%3A0x6f2779f6196e92f6!2sSree%20Kanya%20Movie%20Theatre!5e0!3m2!1sen!2sin!4v1715764734955!5m2!1sen!2sin"" width="100%" height="auto" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
    </div>
    <div class="contact-form">
        <form action="./getTouch" method="POST">
                    <span style="text-align: center; margin:90px 30px;" class="${style}">${msg}&nbsp;&nbsp;${email}</span><br><br><br>
        
            <input type="text" name="name" placeholder="Name" class="contact-form-txt" required>
            <input type="tel" id="phone" name="contact" pattern="[0-9]{10}" required placeholder="Contact number" maxlength="10" class="contact-form-phone">
